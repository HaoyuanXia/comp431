    ...
    return(
        <div>
            <form className='form-horizontal' onSubmit={(event) => {
                ...
                <div className="info" id='registerInfo'>
                    {info}
                </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-7">
                    <input type="password" className="form-control" id="newPasswordConfirm" 
                ...
                <div className="form-group">
                    <input id='register' type="submit" className="btn btn-info" value="Register" />
                </div>
