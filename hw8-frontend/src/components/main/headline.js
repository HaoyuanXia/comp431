...
const Headline = ({user, dispatch}) => {
    return(
        <div className='content headline'>
            ...
            <label className='displayName' id='headlineName'> {user.accountName} </label>
            <div className='space' />
            ...
            <div className='halfSpace' />
            <button id='update' type='button' className='btn btn-primary btn-sm' onClick={() => updateStatus(dispatch)}>Update Status</button>
        </div>
    )
}
