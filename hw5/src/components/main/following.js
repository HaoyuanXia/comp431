...
const SingleUser = ({user,  dispatch}) => {
    ...
    return (
        <li>
            ...
            <div>
                <button type='button' className='btn btn-info btn-sm' onClick={() => remove({dispatch, username: user.username})}>Unfollow</button> 
            </div>
        </li>
    )
}

const Following = ({following, dispatch}) => {
    return (
        <div className='content following'>
            ...
            <div className="input-group">
                ...
                <button type='button' className='btn btn-info btn-sm' onClick={() => add({dispatch})}> Add </button>
            </div>
