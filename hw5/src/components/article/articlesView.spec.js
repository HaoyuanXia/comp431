...
describe('ArticlesView (component tests)', ()=>{
    ...
    it('should render articles', ()=>{
        ...
        const node = shallow(
                <ArticlesView articlesDisplayed={articles} resumeArticles={_=>_} filterArticles={_=>_} />
        )
    ...
    it('should dispatch actions to create a new article', ()=>{
        ...
        const node = shallow(
                <ArticlesView articlesDisplayed={state.articles} resumeArticles={_=>_} filterArticles={_=>_} />
        )
